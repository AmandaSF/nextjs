    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <p>Ranked 5 most favourite and 5 least favourite support tasks.</p>
            <p>Favorites;</p>
              <p>1)Analyze hundreds of support tickets to spot trends the product team can use: I really enjoy finding trends, and determing solutions, what the lift is for changes, and faster/easier ways to get to a resolution</p>
